...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const embed = new Discord.EmbedBuilder()
      .setTitle("Potato Bot's PRIVACY POLICY")
    ...
    We never share your data with anyone except for [MongoDB Inc](https://mongodb.com) whom is a DataBase Company and all the data for our Bot is stored on the MongoDB Servers and According to MongoDB Inc. the data is only accessable by us.`
        ...
        value: `
    If you have any concerns or queries relating our privacy policy or our bot or if you want your data to be removed, You can contact [potatoman_420#9296](https://discord.com/users/789147804109897759) directy on our [Support Server](https://discord.gg/4F2FK2Mt23)!`
        }
      ])
      .setColor("Green");
